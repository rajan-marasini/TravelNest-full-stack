...
const EditPlace = () => {
    ...
    useEffect(() => {
        axios
            .get(`/api/v1/place/getOnePlace/${id}`)
            .then(({ data }) => {
                const { place } = data;
    ...
    const handleSubmit = async (e) => {
        ...
        axios
            .put(`/api/v1/place/update-place/${id}`, {
                title,
                address,
                description,
                extraInfo,
        ...
        <div>
            <form onSubmit={handleSubmit} encType="multipart/form-data">
                ...
                <div className="flex">
                    ...
                    />
                    <button
                        className="bg-primary whitespace-nowrap px-6
                         py-0 rounded-xl disabled:cursor-not-allowed disabled:opacity-60"
                ...
                <button
                    className="primary my-4h disabled:opacity-60 disabled:cursor-not-allowed"
                    disabled={isLoading}
